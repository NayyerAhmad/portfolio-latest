...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Exploring DevOps and Cybersecurity.",
    description: "Broadening my expertise.",
  ...
  {
    id: 6,
    title: "Interested in Collaborating? Let's Start a Project Together!",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const workExperience = [
  {
    ...
    desc: "Assisted in the development of a web-based platform using Next.js, Tailwind CSS, and TypeScript.",
  ...
  // },
  {
    ...
    desc: "Developed interface for a AI chatbot using React, Next.js, and TypeScript.",
    className: "md:col-span-2", // change to md:col-span-2
    thumbnail: "/exp3.svg",
  },
  // {
...
export const socialMedia = [
  {
    id: 1,
    img: "/git.svg",
    link: "https://github.com/NayyerAhmad"
  },
  {
    id: 2,
    img: "/link.svg",
    link: "https://www.linkedin.com/in/nayyer-ahmad/"
  },
];